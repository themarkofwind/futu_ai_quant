...
INTRADAY_T_TARGET_SPREAD: float = 2.5
INTRADAY_T_TARGET_SPREAD_AUTO: bool = True
# 开仓时按布林带宽抬高止盈；再与「到中轨距离」「现价×最低百分比」取最大
INTRADAY_T_SPREAD_BOLL_RATIO: float = 0.7
INTRADAY_T_SPREAD_MIN_PCT: float = 0.015  # 开仓价 1.5%；0=关闭
...
_SETTING_SPECS: tuple[tuple[str, str, Any, Any], ...] = (
    ...
    ("INTRADAY_T_TARGET_SPREAD", "INTRADAY_T_TARGET_SPREAD", "float", 2.5),
    ("INTRADAY_T_TARGET_SPREAD_AUTO", "INTRADAY_T_TARGET_SPREAD_AUTO", "bool", True),
    ("INTRADAY_T_SPREAD_BOLL_RATIO", "INTRADAY_T_SPREAD_BOLL_RATIO", "float", 0.7),
    ("INTRADAY_T_SPREAD_MIN_PCT", "INTRADAY_T_SPREAD_MIN_PCT", "float", 0.015),
